...
//
// ==UserScript==
// @name           Linkify (for Microsoft Lync)
// @namespace      http://userscripts.org/scripts/show/113801
// @description    Turn phone numbers into hyperlinks so you can click them to auto-dial using Microsoft Lync
// @include        *
// @version        1.2
//
// @history        1.2 Fixed issue with inserting two ones when phone number starts with a 1
// @history        1.1 Fixed regex
...
(function () {
	...
	function trackUrl(t) {
		...
		return 'tel:'+String(t).replace(/[^0-9+]/ig, "");
	}
